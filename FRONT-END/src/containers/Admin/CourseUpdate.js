...
function CourseUpdate({ form, error, result, AuthActions, MapActions, kakaoMap, kakao, mapResult, history, match, ListActions }) {
  ...
  const handleCourseUpdate = async () => {
    ...
    try {
      await AuthActions.updateCourse({courseId: id, courseName, stations});
