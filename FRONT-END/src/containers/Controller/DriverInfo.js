...
import { Grid, ButtonGroup, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Paper } from '@material-ui/core';
          ...
          <Table className={classes.table} aria-label="simple table">
            <TableBody className={classes.tableBody} >
                ...
                <TableRow key={1}>
                  ...
                  <TableCell align="right">{locSwitch? '????' : '위치공유 필요'}</TableCell>
                </TableRow>
            </TableBody>
          </Table>
        </TableContainer>
