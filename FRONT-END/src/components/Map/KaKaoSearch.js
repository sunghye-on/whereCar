...
const KaKaoSearch = ({MapActions, kakaoMap, pickMarker, kakao, mapResult}) => {
    const [input, setInput] = useState('수원 경기대학교')
    ...
    ps.keywordSearch( "수원 경기대", placesSearchCB); 
    ...
    return (
        ...
        <div id="menu_wrap" class="bg_white">
            <div className="option">
                <div>
                    키워드 : <input type="text" value={input} id="keyword" size="15" onChange={inputHandler}/> 
